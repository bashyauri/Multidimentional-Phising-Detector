...
.venv\Scripts\python.exe -m ml_training.train_deepfake --dataset-dir datasets/faceforensics --batch-size 2 --epochs 15 --frames-per-video 8 --image-size 160 --unfreeze-last-blocks 2 --val-split 0.2 --early-stop-patience 4 --pretrained
