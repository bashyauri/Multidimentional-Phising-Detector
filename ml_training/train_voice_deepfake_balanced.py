...
joblib.dump(clf, "models/voice_model_balanced.pkl")
...
save_confusion_plot(metrics["confusion_matrix"], "voice")
write_metrics("voice", metrics)

print("Model saved to models/voice_model_balanced.pkl")
